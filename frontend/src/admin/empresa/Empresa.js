        ...
        <div className="space-y-6">
          ...
          <section className="p-4 border-2 border-gray-200 rounded-lg shadow-md bg-white">
            ...
            <button
              ...
              className="mt-3 px-4 py-1 bg-black text-white rounded hover:bg-gray-600 flex items-center"
            >
          ...
          <section className="relative p-4 border-2 border-gray-200 rounded-lg shadow-md bg-white">
            ...
            <button onClick={() => setMostrarModalContacto(true)} className="mt-3 px-4 py-1 bg-black text-white rounded hover:bg-gray-600 flex items-center"
            >
              <FaEdit className="mr-2" />
            </button>
          </section>
          ...
          <section className="p-4 border-2 border-gray-200 rounded-lg shadow-md bg-white">
            ...
            <button onClick={() => setMostrarModalValores(true)} className="mt-3 px-4 py-1 bg-black text-white rounded hover:bg-gray-600 flex items-center"
            >
              <FaEdit className="mr-2" />
            </button>
          </section>
            ...
            {empresa.logo ? (
              <div className="relative w-fit inline-block">
                ...
                <button
                  ...
                  className="absolute top-1 right-1 bg-black text-white p-1 rounded-full hover:bg-gray-700 transition"
                  title="Editar logo"
                >
                  <FaEdit size={16} />
                </button>
